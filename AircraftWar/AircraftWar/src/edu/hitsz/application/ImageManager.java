...
public class ImageManager {
    ...
    public static List<BufferedImage> BACKGROUND_IMAGE=new LinkedList<>();
    ...
    static {
        try {
            ...
            BACKGROUND_IMAGE.add(ImageIO.read(new FileInputStream("src/images/bg.jpg")));
            BACKGROUND_IMAGE.add(ImageIO.read(new FileInputStream("src/images/bg2.jpg")));
            BACKGROUND_IMAGE.add(ImageIO.read(new FileInputStream("src/images/bg3.jpg")));
            BACKGROUND_IMAGE.add(ImageIO.read(new FileInputStream("src/images/bg4.jpg")));
            BACKGROUND_IMAGE.add(ImageIO.read(new FileInputStream("src/images/bg5.jpg")));
